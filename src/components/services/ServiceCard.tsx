...
export function ServiceCard({ icon: Icon, title, description }: ServiceCardProps) {
  return (
    <div className="group bg-white/60 rounded-2xl p-6 border border-primary-100 hover:border-primary-200 hover:shadow-md border-l-3 border-l-transparent hover:border-l-primary-500 transition-all duration-300">
