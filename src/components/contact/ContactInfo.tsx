...
export function ContactInfo() {
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* Opening hours */}
      <div className="bg-white/60 rounded-2xl p-6 border border-primary-100">
        <div className="flex items-center gap-3 mb-4">
          <div className="flex-shrink-0 w-11 h-11 rounded-xl bg-primary-100 flex items-center justify-center text-primary-600">
            <Clock size={20} />
          </div>
