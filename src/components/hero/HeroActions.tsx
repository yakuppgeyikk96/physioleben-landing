  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
      <a
        ...
        className="inline-flex items-center justify-center gap-2.5 rounded-full bg-primary-600 px-8 py-4 text-base font-semibold text-white hover:bg-primary-700 hover:scale-105 transition-all duration-200 shadow-md shadow-primary-600/20"
      >
